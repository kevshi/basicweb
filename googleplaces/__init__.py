...
__all__ = ['GooglePlaces', 'GooglePlacesError', 'GooglePlacesAttributeError',
           'geocode_location']
__version__ = '1.0.1'
__author__ = 'Justin Liu'
__email__ = 'jusliu@gmail.com'
...
class Place(object):
    ...
    def opening_hours(self):
        ...
        return self.details.get('opening_hours')

    @property
    def price_level(self):
        """Returns the price level of the place."""
        return self.details.get('price_level')
